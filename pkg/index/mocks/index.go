...
func (m *MockManager) FindArtifacts(name string) (map[string][]*model.IndexArtifactDescriptor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindArtifacts", name)
	ret0, _ := ret[0].(map[string][]*model.IndexArtifactDescriptor)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockManager) ResolveArtifact(name, version, os, arch string) (*model.IndexArtifactDescriptor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResolveArtifact", name, version, os, arch)
	ret0, _ := ret[0].(*model.IndexArtifactDescriptor)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
