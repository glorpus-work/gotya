...
// Source: github.com/glorpus-work/gotya/pkg/orchestrator (interfaces: ArtifactResolver,ArtifactReverseResolver,ArtifactManager,Downloader)
//
...
// SetArtifactManuallyInstalled mocks base method.
func (m *MockArtifactManager) SetArtifactManuallyInstalled(artifactName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetArtifactManuallyInstalled", artifactName)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetArtifactManuallyInstalled indicates an expected call of SetArtifactManuallyInstalled.
func (mr *MockArtifactManagerMockRecorder) SetArtifactManuallyInstalled(artifactName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetArtifactManuallyInstalled", reflect.TypeOf((*MockArtifactManager)(nil).SetArtifactManuallyInstalled), artifactName)
}
